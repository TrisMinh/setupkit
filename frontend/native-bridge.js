(() => {
  ...
  window.setupkitNative = Object.freeze({
    ...
    listPackageVersions: (packageId) => invoke('ListPackageVersions', packageId),
    ...
    runWingetConfirmed: (packageId) => invoke('RunWingetConfirmed', packageId),
    upgradeApp: (packageId) => invoke('UpgradeApp', packageId),
    upgradeAppConfirmed: (packageId) => invoke('UpgradeAppConfirmed', packageId),
    upgradeApps: (packageIds) => invoke('UpgradeApps', packageIds),
    upgradeAppsConfirmed: (packageIds) => invoke('UpgradeAppsConfirmed', packageIds),
    installVersion: (packageId, version, mode) => invoke('InstallVersion', packageId, version, mode),
    installVersionConfirmed: (packageId, version, mode) => invoke('InstallVersionConfirmed', packageId, version, mode),
    uninstallApp: (packageId) => invoke('UninstallApp', packageId),
    uninstallAppConfirmed: (packageId) => invoke('UninstallAppConfirmed', packageId),
